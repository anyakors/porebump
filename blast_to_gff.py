...
blastn -word_size 10 -gapopen 2 -gapextend 2 -penalty -1 -reward 1 -query ./all_T.fasta 
-subject ./RNA3_T.fa -outfmt '6 sseqid sstart send qseqid qlen qstart qend sframe bitscore' > 
./blast_out6
